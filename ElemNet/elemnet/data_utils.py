...
def load_csv(train_data_path, test_data_path=None, input_types = None, label =None, test_size=None, val_size=0):
    print('train data path is ', train_data_path)
    data_f = pd.read_csv(train_data_path)
    print('input attribute sets are: ', input_types)
    if test_data_path:
        print('test data path is ', test_data_path)
        data_ft = pd.read_csv(test_data_path)
    elif test_size:
        print('splitting data into with test ratio=', test_size)
    ...
    print('input attributes are: ', input_attributes)
    print('label:', label)
    ...
    print(data_ft.describe())
    valid_X = data_fv[input_attributes].as_matrix()
    valid_y = data_fv[label].as_matrix()
    print(data_fv.describe())
    print(' train, test, valid sizes: ', train_X.shape, train_y.shape, test_X.shape, test_y.shape, valid_X.shape, valid_y.shape)
