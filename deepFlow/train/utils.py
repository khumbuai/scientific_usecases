...
def readProportions():
    ...
    while flag:
        input_proportions = input(
            "Enter total nubmer of training files and proportions for training (normal, superimposed, sheared respectively) seperated by a comma such that they add up to 1: ")
